...
export function PlasmaEffect({ params }: PlasmaEffectProps) {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uAudioLevel: { value: 0 },
      uPlasmaComplexity: { value: params.plasmaComplexity || 5 },
  ...
  useFrame((state) => {
    if (materialRef.current) {
      ...
      materialRef.current.uniforms.uPlasmaComplexity.value = params.plasmaComplexity || 5;
