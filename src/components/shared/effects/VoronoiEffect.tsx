...
import { voronoiVertexShader, voronoiFragmentShader } from '../../../shaders/voronoi';
import type { VisualizationParams } from '../../../types';
import { useAudioStore } from '../../../stores/audioStore';

interface VoronoiEffectProps {
  params: VisualizationParams;
}

export function VoronoiEffect({ params }: VoronoiEffectProps) {
  ...
  const uniforms = useMemo(
    () => ({
      ...
      uAudioLevel: { value: 0 },
      uVoronoiCells: { value: params.voronoiCells || 20 },
      uVoronoiEdgeWidth: { value: params.voronoiEdgeWidth || 0.02 },
  ...
  useFrame((state) => {
    if (materialRef.current) {
      ...
      materialRef.current.uniforms.uVoronoiCells.value = params.voronoiCells || 20;
      materialRef.current.uniforms.uVoronoiEdgeWidth.value = params.voronoiEdgeWidth || 0.02;
