...
import { metaballsVertexShader, metaballsFragmentShader } from '../../../shaders';
import type { VisualizationParams } from '../../../types';
import { useAudioStore } from '../../../stores/audioStore';

interface MetaballsEffectProps {
  params: VisualizationParams;
}

export function MetaballsEffect({ params }: MetaballsEffectProps) {
